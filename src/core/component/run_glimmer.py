...
#         self.g3Iterated.set_param_at(v)
    ...
    def setOutputTag(self, outfile):
        """
        """
        self.glimmer.set_param_at(outfile, 3)
    ...
    #            Check *.detail outfile:
        ...
        longorfsOutfile=infile+".longorfs"
        ...
        run1detailOutfile=infile+".run1.detail"
        print "*.run1.detail file:",run1detailOutfile
        self.run1.detailOutfile_path="%s%s" % (self.pdir, run1detailOutfile)
        if os.path.exists(self.run1.detailOutfile_path):
        ...
        run1predictOutfile=infile + ".run1.predict"
        print "*.run1.predict file:",run1predictOutfile
        self.run1.predictOutfile_path="%s%s" % (self.pdir, run1predictOutfile)
        if os.path.exists(self.run1.predictOutfile_path):
        ...
        upstreamOutfile=infile + ".upstream"
