...
class OBOParser(object):
    ...
    def parse_database(self):
        '''
        version and date should be the first two line in the file
        e.g.
        format-version: 1.2
        ...
        print "Begin parsing database version: %s date: %s" %(self.version, self.date)
...
#        pickle.dump(self.version, save_file)
    ...
    def load_dict_file(self):
        self.dict_file = open(self.file, "r") 
