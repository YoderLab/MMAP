...
class TestRunGenovo(unittest.TestCase):
    ...
    def test_RunGenovo_init(self):
        ...
        self.assertEqual(genovo.assemble.get_extract_switch()[0], expected_infile)
        self.assertEqual(genovo.assemble.get_extract_switch(), [expected_infile, "1"])
    ...
    def test_RunGenovo_simple_assemble(self):
        ...
        self.assertEqual(genovo.assemble.get_extract_switch(), expected)
        ...
        self.assertEqual(genovo.assemble.get_extract_switch(), [infile_var, "10"])
    ...
    def test_RunGenovo_finalise_outfile(self):
        ...
        self.assertEqual(genovo.finalize.get_extract_switch(),
                             expected)
    ...
    def test_RunGenovo_set_infile_outfile(self):
        ...
        genovo.set_infile_name(infile_var)
        self.assertEqual(genovo.assemble.get_extract_switch(), [infile_var, "3"])
        expected = ["250", self.data_dir + outfile_var,
                    infile_var + ".dump.best"]
        self.assertEqual(genovo.finalize.get_extract_switch(), expected)
    ...
    def test_RunGenovo_set_number_of_iter(self):
        ...
        try:
            ...
            self.fail(e)
        self.assertEqual(genovo.assemble.get_extract_switch()[run_genovo.ASSEMBLE_NO_ITER_POSITION - 1], "300")
