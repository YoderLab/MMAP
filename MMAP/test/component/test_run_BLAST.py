...
#
# print(1, k, seq)
# print(2, seq.combined_terms)
# print(3, seq.each_term)
# (1, 'lcl|AE014075.1_gene_1', <core.zdeprecated.sequence.Sequence object at 0x2ec9ad0>)
# (2, set([]))
# (3, {})
# (1, 'lcl|AE014075.1_gene_3', <core.zdeprecated.sequence.Sequence object at 0x25e7bd0>)
...
# (1, 'lcl|AE014075.1_gene_2', <core.zdeprecated.sequence.Sequence object at 0x2ec9e50>)
...
# (1, 'lcl|AE014075.1_gene_5', <core.zdeprecated.sequence.Sequence object at 0x2ec9f10>)
...
#
#        blast = RunBlast(self.record_index, self.e_threshold)
...
#            blast.results[k].combined_terms = v
